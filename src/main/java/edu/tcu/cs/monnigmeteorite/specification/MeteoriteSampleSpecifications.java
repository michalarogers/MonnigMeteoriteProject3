...
public class MeteoriteSampleSpecifications {
    ...
    public static Specification<MeteoriteSample> findByCriteria(String name, String classType, String meteoriteGroup, String country, String foundOrFall) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (meteoriteGroup != null && !meteoriteGroup.isEmpty()) {
                predicates.add(criteriaBuilder.equal(root.get("meteoriteGroup"), meteoriteGroup));
            }
